...
export default function ThermalBridges({ data, location }: PageProps<Queries.ThermalBridgesQuery>) {
    ...
    return (
        <>
            <Layout heroTextContent={heroText.workshopsMostki} heroBackgroundImage={heroImage} heroClass={'hero__subpage'} metaTags={metaTags}>
                    ...
                    <ContainerBlue
                        text={
                            <>
                                ...
                                <p>
                                    Mostki termiczne są to obszary przegród zewnętrznych budynku, które wyraźnie różnią się przewodnictwem cieplnym w stosunku
                                    do otaczających je obszarów. Są to miejsca, w których przepływ ciepła jest najczęściej wyraźnie zwiększony. To one, w dużej
                                    mierze odpowiadają za niekontrolowaną utratę, zgromadzonego w budynkach ciepła. Innymi słowy, mostek termiczny jest swego
                                    rodzaju autostradą, którą odbywa się podróż ciepła z punktu A (cieplejszy obszar) do punktu B (zimniejszy obszar). Ciepło
                                    zawsze wybiera drogę najmniejszych oporów. <strong className="mostki-definition">Mostki termiczne</strong> mogą być nazywane{' '}
                        ...
                        textEnd={
                            <>
                                <p>
                                    ...
                                    zgodnie z najnowszą wersją normy <strong>PN-EN ISO 10211:2017-09</strong> oraz dostarczenie niezbędnej wiedzy do oceny
                                    wpływu tych obszarów o zwiększonym przewodnictwie cieplnym na ogólną stratę energii w budynkach.
                                </p>
                                <p>
                                    Absolwenci szkolenia posiadają umiejętność wykorzystywania metodyki obliczeniowej podczas projektowania budynków oraz
                                    przeprowadzania audytów energetycznych. Dzięki umiejętności liczenia mostków termicznych mogą skutecznie współpracować z
                                    PIBP przy tworzeniu energooszczędnych domów i budynków, w tym budynków pasywnych, które stanowią najwyższy standard
                    ...
                    <ContainerColumn
                        textStart={
                            <>
                                ...
                                <p>
                                    W szczególności osoby z branży budowlanej zainteresowane poszerzeniem swojej wiedzy zawodowej, w tym absolwenci szkoleń i
                                    kursów z zakresu{' '}
                                    <strong>
                        ...
                        textStart={
                            <>
                                <p>
                                    ...
                                    <strong>Therm</strong> to aplikacja do modelowania termicznego, która umożliwia wykonanie dokładnych symulacji, ocenę
                                    zachowania elementów budynku pod względem termicznym, oraz poprawę rozwiązań konstrukcyjnych w celu zwiększenia efektywności
                                    energetycznej.
                                </p>
                                <p>
                                    Analiza przenikania ciepła w programie <strong>Therm</strong> pozwala określić skuteczność komponentów i materiałów
                                    budowlanych w kontekście efektywności energetycznej oraz oszacować lokalne wzorce temperatur, które mogą mieć wpływ na
                                    ewentualne problemy z kondensacją powierzchniową.
                                </p>
                            </>
                        }
                        noBorder
                    ...
                    <ContainerColumn
                        textStart={
                            <>
                                ...
                                <p>
                                    1. Uczestnicy zainteresowani udziałem w szkoleniu powinni mieć podstawową wiedzę na temat ochrony cieplnej budynków, taką
                                    jak współczynnik przenikania ciepła U i współczynnik przewodzenia ciepła λ. Zalecana podstawowa znajomość języka
                                    angielskiego, ponieważ program Therm jest w języku angielskim.
                                </p>
                                <p>
                                    2. Komputer z systemem Windows w wersji nie niższej niż 7 oraz zainstalowanym arkuszem kalkulacyjnym Microsoft Excel z
                                    dostępem do programu Therm, aby móc aktywnie uczestniczyć w praktycznych zajęciach.
                                </p>
                            </>
                        }
                        noBorder
                                                        ...
                                                        answer={
                                                            <>
                                                                <p>
                                                                    ...
                                                                    stropem, miejsca obsadzenia okien i drzwi, nadproża, fundamenty, połączenie stropu lub dachu
                                                                    ze ścianą zewnętrzną. Zdjęcie obrazuje przykład mostka termicznego – styk ściany zewnętrznej
                                                                    z płytą fundamentową co stanowi niekorzystną sytuację.
                                                                </p>
                                                            </>
                                                        }
                                                    ...
                                                    <Question
                                                        ...
                                                        answer={
                                                            <div className="faq-question-multiple-sections">
                                                                ...
                                                                <p>
                                                                    Budowanie bez mostków termicznych okazało się być jedną z kluczowych zasad planowania
                                                                    budynków pasywnych. Budownictwo pasywne wykracza daleko poza domy pasywne jednorodzinne. Od
                                                                    15 lat skutecznie realizowane są ogromne projekty budynków pasywnych, takie jak hale
                                                                    sportowe, produkcyjne, szkoły, biura i szpitale.
                                                                </p>
                                                            </div>
                                                        }
                                                    />
