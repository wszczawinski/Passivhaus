...
import { Button, ContainerColumn, ContainerRow, FullImageContainer, Layout } from '@/components';
                ...
                <ContainerColumn
                    textStart={
                        <p>
                            ...
                            <Button className="faq-button" onClick={handleFaqButton} content={'FAQ'} />
                            {faqOpened && (
                                <p>
                                    <ul className="faq-ul">
                                        <li>
                                            ...
                                            zaprojektowany. Zasadniczą kwestią jest choćby znajomość pakietu do planowania budynków pasywnych. Jeżeli nie znasz
                                            możliwości oprogramowania PHPP (Passive House Planing Package) to prawdopodobnie nie bierzesz pod uwagę wielu
                                            ważnych aspektów podczas planowania budynku pasywnego. W efekcie nie dopracowany projekt a następnie na jego
                                            podstawie zrealizowany budynek w najlepszym wypadku będzie jedynie uchodził za pasywny, ale w rzeczywistości nie
                                            spełni kryteriów certyfikacji ‘passivhaus’.
                                        </li>
                                        <li>
                                            <strong>Jak zostać Certyfikowanym Projektantem a jak zostać Certyfikowanym Doradcą ?</strong>
                                            <br />
                                            <br />
                                            Po pomyślnym zakończeniu egzaminu Polski Instytut Budownictwa Pasywnego i Energii Odnawialnej wyśle do Niemieckiego
                                            Instytutu Budownictwa Pasywnego rekomendację z proponowanym tytułem Certyfikowanego Projektanta lub Certyfikowanego
                                            Doradcy. Niemiecki Instytut Budownictwa Pasywnego po otrzymaniu rekomendacji ze strony PIBP analizuje dokumenty
                                            uczestnika. W tym wypadku są to świadectwa wykształcenia. Przedłożenie dyplomu z kierunków budownictwo i
                                            architektura uprawnia PIBPiEO do rekomendacji na Certyfikowanego Projektanta. Uprawnienia budowlane do projektowania
                                            nie są wymagane. Na potrzeby tej decyzji wymagana jest jedynie udokumentowana wiedza wynikająca z wykształcenia.
                                            <br />
                                            <br />
                                            Obydwa tytuły są równoważne pod względem kwalifikacji w zakresie wiedzy związanej z budownictwem pasywnym. Warunki
                                            uzyskania tego certyfikatu i jego odnowienia również są takie same. Z reguły projektanci domów pasywnych pracują w
                                            biurach projektowych nad konkretnym wdrożeniem standardu domów pasywnych, podczas gdy doradcy zazwyczaj przyczyniają
                                            się do jego upowszechniania poprzez swoją pracę jako konsultanci, badacze, eksperci.
                                            <br />
                                            <br />
                                            Osoby, które są po kierunkach niezwiązanych z budownictwem i architekturą lub nie przedłożą świadectw wykształcenia
                                            otrzymają tytuł Certyfikowanego Doradcy.
                                            <br />
                                            <br />
                                            Wszyscy uczestnicy kursu zdają ten sam egzamin. Wyjściowy stopień trudności egzaminu i w efekcie wiedza przekazana
                                            na kursie CEPHd, są jednakowe i te same dla Certyfikowanych Projektantów i Doradców.
                                        </li>
                                        <li>
                                            ...
                                            zostanie nam dostarczony. W przypadku nieprzedstawienia dowodu wykształcenia, przyznawany jest automatycznie tytuł
                                            Certyfikowanego Doradcy – w przypadku pozytywnego wyniku egzaminu.
                                        </li>
                                        <li>
                                            <strong>Ile trzeba zdobyć punków aby ukończyć egzamin z wynikiem pozytywnym ?</strong>
                                            <br />
                                            <br />
                                            Do uzyskania tytułu Certyfikowanego Projektanta \ Doradcy Budownictwa Pasywnego wymagane jest uzyskanie minimum 50%
                                            z wszystkich możliwych do zdobycia punktów egzaminacyjnych.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <br />
                                            <br />
                                            Certyfikat może zostać przedłużony tylko za pomocą przykładowego projektu domu pasywnego; Odnowa będzie ważna przez
                                            kolejne pięć lat. Odpowiedzialny i rzetelny projektant CEPHd musi opracować projekt (przykładowy) budynku pasywnego
                                            (Certified Passive House/EnerPHit building) lub niskoenergetycznego (PHI Low Energy Building), który zostanie
                                            umieszczony na stronie PHI po zakończeniu procesu odnowy. Oficjalną datą złożenia wniosku będzie dzień, w którym
                                            wszystkie niezbędne dokumenty i informacje zostały udostępnione Passive House Institute w Darmstadt.
                                            <br />
                                            <br />
                                            Czasowość certyfikatu jest zamierzona. Wbrew pozorom jest to słuszne podejście, ponieważ osoby, które wydały
                                            znaczące pieniądze na swoje doskonalenie zawodowe, biorąc udział w kursie CEPHd i egzaminie powinny rozwijać swoje
                                            umiejętności zdobyte na kursie. Poznanie tajników oprogramowania PHPP, sprawne posługiwanie się tym programem i
                                            optymalne jego wykorzystanie w planowaniu budynków (nie tylko pasywnych) jest możliwe tylko przez dalszą praktykę
                                            zawodową. Nie da się opanować w 100% programu PHPP przez uczestnictwo jedynie w szkoleniu. Nie da się również
                                            zaprojektować budynku rzeczywiście pasywnego, czyli wg kryteriów ‘Passivhaus’ bez wykorzystania kalkulacji z
                                            programu PHPP.
                                        </li>
                                        <li>
                                            <strong>
                                            ...
                                            .
                                            <br />
                                            2. Obliczenia PHPP na podstawie, których został wydany certyfikat – wymagany plik w formie cyfrowej (niechroniony
                                            plik Ex-cel).
                                            <br />
