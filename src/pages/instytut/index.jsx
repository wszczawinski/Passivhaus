        ...
        <Layout>
            <section className="layout-content">
                <ContainerRow text={<p>
                        ...
                        zasadach non-profit. Naszym celem jest upowszechnianie wiedzy o{' '}
                        <strong>
                            budownictwie pasywnym, zero energetycznym, plus energetycznym oraz o
                            kompleksowej termomodernizacji{' '}
                        </strong>{' '}
                        z wykorzystaniem technologii i komponentów pasywnych. Ponadto transferujemy
                        wiedzę na temat energii odnawialnej, która z powodzeniem pokrywa potrzeby
                        budynków energetycznie pasywnych.
                    </p>} imgSrc={oNas1} alt="Budynek Instytutu w Gdańsku" />
                ...
                <div className="about-paragraph__icons">
                    <div className="about-paragraph__icons--row">
                        <span className="about-paragraph__icons--single-icon">
                ...
                <div className="about-paragraph__blue">
                <span className="about-paragraph__border"></span>
                    <p>
                        Naszym głównym celem jest popularyzacja i transfer wiedzy z zakresu
                        budownictwa pasywnego oraz szerokie promowanie tego standardu. Organizujemy
                        konferencje, fora i spotkania dające możliwość wymiany doświadczeń,
                        pogłębienia wiedzy oraz nawiązania nowych kontaktów. Przygotowujemy i
                        opracowujemy materiały szkoleniowo - dydaktyczne (dla doskonalenia
                        zawodowego) i informacyjne dla projektantów budynków pasywnych oraz
                        wykonawców takich budynków. Chętnie wspieramy ambitne wydarzenia, takie jak
                        międzynarodowe i lokalne targi budowlane, ponieważ poprawa efektywności
                        energetycznej naszego kraju jest w największej mierze uzależniona od poziomu
                        świadomości społeczeństwa polskiego.
                        <StaticImage src="../../images/firm/icons/leaf.svg" />
                    </p>
                </div>
            </section>
        </Layout>
