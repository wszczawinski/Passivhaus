...
export default function Team({ data }: PageProps<Queries.TeamQuery>) {
    const heroImage = getImage(data.heroImage);

    return (
        <Layout heroTextContent={heroText.instytutZespół} heroClass={'hero__subpage'} heroBackgroundImage={heroImage}>
            <section className="layout-content">
                <div className="team">
                    <p>
                        Naszym podejściem jest pełne zweryfikowanie Twojego marzenia, czyli projektu budynku, zgodnie z wiodącymi na świecie zasadami
                        energooszczędnego projektowania. My nie skupiamy się na pięknym efekcie architektonicznym (to pozostawiamy naszym utalentowanym
                        absolwentom - CEPHdesigners ). Wdrażamy zasady projektowania budynków pasywnych we wszystkie sprawdzane przez nas projekty, tak aby
                        każda zweryfikowana przez naszych certyfikatorów dokumentacja rokowała możliwie wysoką efektywność energetyczną.
                    </p>
                    <p>
                        Zrównoważony rozwój dotyczy każdego aspektu naszego życia. Naszym zdaniem efektywność energetyczna jest tak samo ważna jak styl
                        architektoniczny. Obie te kwestie wpływają na trwałość budynku i otaczające środowisko.
                    </p>
                </div>
