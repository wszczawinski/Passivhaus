...
export default function Ambassador({ data }: PageProps<Queries.AmbassadorQuery>) {
    const heroImage = getImage(data.heroImage);
    return (
        <Layout heroTextContent={heroText.ambassador} heroBackgroundImage={heroImage} heroClass={'hero__subpage'}>
